...

{
    ...
    "dns": {
        ...
        [
            ...
            {"rule_set": "geo-cn-site", "action": "route","server": "dns_direct"},
            {"rule_set": "geo-!cn-site", "server": "dns_proxy"}
        ],
        "final": "dns_proxy",
        "strategy": "ipv4_only",
        "fakeip": {
    ...
    "route": {
        ...
        "rule_set": [   
            { "tag": "geo-!cn-site", "type": "remote", "format": "binary", "url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/geolocation-!cn.srs", "download_detour": "🔰 节点选择" },
            { "tag": "geo-cn-site", "type": "remote", "format": "binary", "url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/cn.srs", "download_detour": "🔰 节点选择" },
            { "tag": "geo-cn-ip", "type": "remote", "format": "binary", "url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geoip/cn.srs", "download_detour": "🔰 节点选择" }
        ]
    },
    "experimental": {
        "clash_api": {
